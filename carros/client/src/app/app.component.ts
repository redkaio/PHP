...
export class AppComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    ngOnInit() {
        ...
        this.menuService.itens = [
            { label: 'Login', icon: 'supervisor_account', routerLink: ['/'] },
            { label: 'Home', icon: 'dashboard', routerLink: ['/home'] },
            { label: 'Funcionários', icon: 'polymer', routerLink: ['/funcionarios'] },
            { label: 'Filiais', icon: 'polymer', routerLink: ['/filiais'] },
            { label: 'Veiculos', icon: 'polymer', routerLink: ['/veiculos'] },
